...
export class ADMIN_ADDNEW_PROD extends Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        let current_categories = this.props.categories
        ...
        console.log(current_subcategories)
...
export default ADMIN_ADDNEW_PROD