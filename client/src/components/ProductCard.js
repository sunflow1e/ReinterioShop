        ...
        return (
            <div class="ProductsCard">
                {this.props.product.product_discount !== 0 &&
                    <div class="Pdiscount">  {"-" + this.props.product.product_discount + "%"} </div>
                }
                <a href={"/product/" + this.props.product.productd_id}>
                    <div className='PCardImgContainer'>
                    <img class="PCardImg" src={"./img/" + this.props.product.image_path} alt=""></img>
                    </div></a>
                <div
                ...
                <div class="PCardInfo">
                    ...
                    <div class="PNamePrice">
                        <p class="ProductName"><h class="CardText">{this.props.product.product_name}</h></p>
                        <div class="PPrice">
                            <a class="ProductPrice"><h class="CardText">{new Intl.NumberFormat().format(this.props.product.product_price) + " ₽"}</h></a>
                            {this.props.product.product_discount > 0 &&
                                <a class="ProductsPriceBefore">{new Intl.NumberFormat().format(this.props.product.product_disc_price) + " ₽"}</a>
                            }
                        </div>
                    </div>
                    {(this.props.product_discount === null || this.props.product_discount === 0) &&
                        <p class="PRating"><h class="CardText">★ {this.props.product.ProductRating}</h></p>
                    }
                </div>
            </div>
        )
